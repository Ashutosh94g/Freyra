...
def javascript_html():
    ...
    history_js_path = webpath('javascript/history.js')
    samples_path = webpath(os.path.abspath('./sdxl_styles/samples/freyra_v2.jpg'))
    ...
    head += f'<script type="text/javascript" src="{history_js_path}"></script>\n'
